 ...
 */
module.exports = (input, { multi = false } = {}) => { 
    ...
    // This is used for things like Packages or Release.
    // A control file will only have one so it doesn't need to do it.
    ...
    const processing = multi ? input.split(/\n{2,}/) : [input];

    const res = processing.reduce( (acc, paragraph) => {
